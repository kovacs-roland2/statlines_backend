    ...
    try:
        ...
        session.execute(text("""
            CREATE TABLE IF NOT EXISTS team_squad_standard_for (
                ...
                minutes_played_90s NUMERIC(4, 1),
                goals INTEGER,
                assists INTEGER,
                ...
                non_penalty_expected_goals NUMERIC(5, 2),
                expected_assisted_goals NUMERIC(5, 2),
                npxg_plus_xag NUMERIC(5, 2),
                progressive_carries INTEGER,
                progressive_passes INTEGER,
                goals_per90 NUMERIC(4, 2),
                assists_per90 NUMERIC(4, 2),
                goals_and_assists_per90 NUMERIC(4, 2),
                goals_minus_penalties_per90 NUMERIC(4, 2),
                goals_and_assists_minus_penalties_per90 NUMERIC(4, 2),
                expected_goals_per90 NUMERIC(4, 2),
                expected_assisted_goals_per90 NUMERIC(4, 2),
                expected_goals_and_assists_per90 NUMERIC(4, 2),
                non_penalty_expected_goals_per90 NUMERIC(4, 2),
                npxg_plus_xag_per90 NUMERIC(4, 2),
